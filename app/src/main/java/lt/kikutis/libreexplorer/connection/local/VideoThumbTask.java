...
public class VideoThumbTask extends ThumbTask {
    ...
    protected Drawable doInBackground(Void... params) {
        Cursor c = getContext().getContentResolver().query(
                MediaStore.Video.Media.EXTERNAL_CONTENT_URI, new String[]{MediaStore.MediaColumns._ID},
                MediaStore.MediaColumns.DATA + "=?", new String[]{getFile().getPath()}, null);
        ...
        if (c != null) {
            if (c.moveToFirst()) {
                ...
                bitmap = MediaStore.Video.Thumbnails.getThumbnail(getContext().getContentResolver(), id,
        ...
        if (bitmap == null) {
            ...
            bitmap = ThumbnailUtils.createVideoThumbnail(getFile().getPath(), MediaStore.Video.Thumbnails.MICRO_KIND);
        }
